...
<html lang="en">
  <head>
    ...
    <title> Sistem Informasi Teknik Informatika Politeknik Kampar </title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-database fa-2x" style="color:yellow"><span><font size="4.98" color="white" >&nbsp;APLIKASI AKADEMIK</font></span></a>
            </center>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/imagee.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Iwan Mardianyah</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/imagee.jpg" alt="">iwan
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-left">
            Copyright @ 2021 aplikasi akademik by iwan berbagi info
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
